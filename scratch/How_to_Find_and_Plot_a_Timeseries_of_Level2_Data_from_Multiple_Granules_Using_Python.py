...
'''
Since I already created the aggfile I will not do the following:
...
data_rootdir = '/run/media/thearty/scratch/data/' 
...
if title_string == "Mauna Loa":
    ...
    mlo_insitu_daily = pd.read_csv('/run/media/thearty/scratch/data/BiomassBurning/MaunaLoa/daily_in_situ_co2_mlo.csv',skiprows=34,names=['Yr','Mn','Dy','CO2','NB','scale']) 
