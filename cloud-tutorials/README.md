...
|[How to Access and Analyze GPM Data from the S3 Giovanni Cache Zarr Store](notebooks/How_to_Access_and_Analyze_GPM_Zarr_Store.ipynb.ipynb) | This notebook demonstrates how to access the Giovanni Cache Zarr Store [S3 bucket](https://disc.gsfc.nasa.gov/information/faqs?keywords=%22earthdata%20cloud%22&title=What%20is%20S3%20access%3F) inside the [AWS us-west-2](https://disc.gsfc.nasa.gov/information/documents?title=Migrating%20to%20the%20Cloud) region for performing analysis.  | |
